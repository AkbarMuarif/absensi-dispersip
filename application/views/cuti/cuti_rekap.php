...
<head>
    ...
    <title>Rekap Data Cuti Pegawai</title>
</head>
<body>
    <div style="width: 100%; margin-left:-5px ; margin-right:-5px">
        ...
        <p style="font-size:16px; line-height:70%; text-align:center"><b>REKAP DATA CUTI PEGAWAI DI KANTOR DISPERSIP (DINAS PERPUSTAKAAN DAN KEARSIPAN)</b></p>
        ...
        <table border="1" cellspacing="0" cellpadding="2" width="100%" style="font-size: 12px">
            ...
            <tr style="text-align:center">
                <td><?= $no++?></td>
                <td><?= $data->id_cuti?></td>
                <td><?= indo($data->tgl_mulai)?></td>
                <td><?= indo($data->tgl_selesai)?></td>
                <td><?= $data->nip?></td>
