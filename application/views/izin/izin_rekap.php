...
<head>
    ...
    <title>Rekap Data Izin Keluar</title>
</head>
<body>
    <div style="width: 100%; margin-left:-5px ; margin-right:-5px">
        ...
        <p style="font-size:16px; line-height:70%; text-align:center"><b>REKAP DATA IZIN KELUAR PEGAWAI DI KANTOR DISPERSIP (DINAS PERPUSTAKAAN DAN KEARSIPAN)</b></p>
